  ...
  methods: {
    ...
    fillParent: function (e) {
      ...
      const animate = () => {
        ...
        console.log('resizing',this.left, this.top, this.width, this.height)
      }
    ...
    handleMove: function (e) {
      ...
      if (this.resizing) {
        if (this.handle.indexOf('t') >= 0) {
          console.log('TTTTTTTT','this.ratio is',this.ratio)
          ...
          this.elmY += diffY
          this.elmH -= diffY
      console.log('this.mouseOffX,this.mouseOffY',this.mouseOffX,this.mouseOffY)
        }
